# برومبت التنفيذ: بناء استثناءات وإدارة أخطاء الترجمة (01_IMPLEMENT_IDE)

```text
أنت تعمل كمطور برمجيات محترف داخل مشروع: LinguaChat.
أنت تنفذ المهمة: TASK-07-TRANSLATION-ERROR-HANDLING (بناء استثناءات وإدارة أخطاء الترجمة).
