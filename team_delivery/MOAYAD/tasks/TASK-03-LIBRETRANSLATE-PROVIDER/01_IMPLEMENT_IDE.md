# برومبت التنفيذ: بناء مزود الترجمة الأساسي LibreTranslate (01_IMPLEMENT_IDE)

```text
أنت تعمل كمطور برمجيات محترف داخل مشروع: LinguaChat.
أنت تنفذ المهمة: TASK-03-LIBRETRANSLATE-PROVIDER (بناء مزود الترجمة الأساسي LibreTranslate).
