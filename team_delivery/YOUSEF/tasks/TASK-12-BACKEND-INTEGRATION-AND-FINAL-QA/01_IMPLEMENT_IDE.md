# برومبت التنفيذ: الفحص النهائي الشامل لحزمة الـ Backend REST (01_IMPLEMENT_IDE)

```text
أنت تعمل كمطور برمجيات محترف داخل مشروع: LinguaChat.
أنت تنفذ المهمة: TASK-12-BACKEND-INTEGRATION-AND-FINAL-QA (الفحص النهائي الشامل لحزمة الـ Backend REST).
