# برومبت التنفيذ: بناء دالة اعتمادية المستخدم الحالي get_current_user (01_IMPLEMENT_IDE)

```text
أنت تعمل كمطور برمجيات محترف داخل مشروع: LinguaChat.
أنت تنفذ المهمة: TASK-07-USERS-AUTH-DEPENDENCY (بناء دالة اعتمادية المستخدم الحالي get_current_user).
