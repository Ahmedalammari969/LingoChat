# برومبت التنفيذ: تهيئة قاعدة البيانات وجلسات الاتصال غير المتزامنة (01_IMPLEMENT_IDE)

```text
أنت تعمل كمطور برمجيات محترف داخل مشروع: LinguaChat.
أنت تنفذ المهمة: TASK-01-DATABASE-FOUNDATION (تهيئة قاعدة البيانات وجلسات الاتصال غير المتزامنة).
