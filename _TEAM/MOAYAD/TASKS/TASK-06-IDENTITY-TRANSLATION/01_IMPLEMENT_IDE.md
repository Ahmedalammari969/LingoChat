# برومبت التنفيذ: تطبيق قاعدة الـ Identity لتطابق اللغات (01_IMPLEMENT_IDE)

```text
أنت تعمل كمطور برمجيات محترف داخل مشروع: LinguaChat.
أنت تنفذ المهمة: TASK-06-IDENTITY-TRANSLATION (تطبيق قاعدة الـ Identity لتطابق اللغات).
